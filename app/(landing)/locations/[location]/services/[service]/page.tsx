...
} from '@/src/lib/country-services';
import { IndustryCard3D } from '@/components/IndustryCard3D';
import { ServiceHero } from '@/src/components/landingPage/servicesPage/service-hero';
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              { name: 'Home', url: '/' },
              { name: page.countryName, url: `/${location}` },
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-16 py-4">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href={`/${location}`}>{page.countryName}</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbItem>
              <BreadcrumbPage>{page.serviceName}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </div>
