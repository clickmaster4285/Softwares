        ...
        <div className="flex-1 flex flex-col gap-8 justify-center">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://www.facebook.com/ClickMasters pvtltd" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              <a href="https://www.pinterest.com/ClickMasters 00" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              <a href="https://www.youtube.com/@ClickMasters official" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
