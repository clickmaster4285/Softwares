...
const ProjectGrid = () => {
  ...
  // Get unique categories (from category names) and filter projects
  const categoryNames = projects ? Array.from(new Set(projects.map(p => getCategoryName(p.category)))) : [];
