  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mb-4 h-1 overflow-hidden rounded-full bg-slate-100">
        <div
          className="h-full bg-gradient-to-r from-accent-500 to-accent-400 transition-all duration-150"
      ...
      <nav className="relative">
        ...
        <div
          className="absolute left-0 w-0.5 rounded-full bg-accent-500 transition-all duration-300"
          style={{
      ...
      {/* Quick action */}
      <div className="mt-6 rounded-xl bg-gradient-to-br from-accent-50 to-accent-100/50 p-4">
        ...
        <Link
          href="/contact-us"
          className="mt-2 inline-flex items-center text-sm font-medium text-accent-600 hover:text-accent-700"
        >
          Book a call
          <svg
