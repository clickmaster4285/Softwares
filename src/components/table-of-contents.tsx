  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <nav className="relative">
        ...
        <div
          className="absolute left-0 w-0.5 rounded-full bg-primary-500 transition-all duration-300"
          style={{
      ...
      {/* Quick action */}
      <div className="mt-6 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100/50 p-4">
