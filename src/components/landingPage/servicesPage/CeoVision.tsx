...
export function CeoVision() {
  return (
    <section className="w-full overflow-hidden">
      <ContainerScroll
        titleComponent={
          <div className="space-y-6 px-4 mt-20">
...
<h2 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl  font-bold ">
  ...
  <span className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">
    Vision
      ...
      >
        {/* Inner card layout: image left, text right */}
       ...
       {/* Right — Text */}
<div className="flex flex-1 flex-col justify-center gap-6 px-6 py-6 md:px-10 md:py-10 bg-white">
  ...
  <blockquote className="text-zinc-800 text-base md:text-xl font-medium leading-relaxed -mt-4">
  ...
  {/* Stats row */}
  <div className="mt-4 grid grid-cols-3 gap-4 border-t border-zinc-100 pt-6">
    {[
