...
const Contact: React.FC = () => {
  ...
  const inputClasses =
    'w-full px-4 py-3 bg-background border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all duration-300 text-foreground placeholder-muted-foreground';
        ...
        <div className="container max-w-[1320px] mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              Reach out to <span className="font-semibold text-primary">ClickMasters</span> for
