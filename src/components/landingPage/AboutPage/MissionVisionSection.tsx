...
export const MissionVisionSection = () => {
  ...
  return (
    <section ref={sectionRef} className="container  py-8 mx-auto max-w-6xl px-4 mb-16 relative">
      ...
      <div className="grid md:grid-cols-2 gap-8 relative">
        ...
        >
          ...
          >
            Our Mission
            <motion.span className="absolute bottom-0 left-0 w-0 h-0.5 group-hover:w-full transition-all duration-500" />
          </motion.h3>
          ...
          >
            To deliver innovative, data-driven software solutions that empower businesses to achieve
            sustainable growth and dominate their markets.
          </motion.p>
        ...
        >
          ...
          >
            Our Vision
            <motion.span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-500" />
          </motion.h3>
          ...
          <motion.p
            ...
            transition={{ duration: 0.2 }}
          >
            To become Pakistan's most trusted and innovative software development company, setting
            new standards of excellence and helping businesses unlock their full potential.
          </motion.p>
