...
export const TrustedPartnerSection = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-black py-16 mb-16 overflow-hidden relative">
      <motion.div
      ...
      <div className="container mx-auto max-w-6xl px-4 relative z-10">
        ...
        >
          ...
          >
            {' '}
            We empower businesses with innovative software solutions for scalable growth and
            transformation.
          </motion.p>
        </motion.div>
      </div>
