    ...
    return (
      ...
      >
        <div className="relative bg-white/50 backdrop-blur-sm rounded-2xl p-6">
          ...
          {/* Glow + CountUp */}
          <p className="relative text-2xl sm:text-3xl md:text-4xl font-bold text-primary">
        ...
        <div ref={ctaRef} className="mt-20">
          <div className="relative bg-gradient-to-br from-gray-50 to-primary/10 rounded-3xl p-12 overflow-hidden border border-primary/10">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <motion.div 
                className="flex flex-col sm:flex-row gap-4 justify-center mt-8 pt-8 border-t border-primary/10"
              >
                {/* Primary Button */}
