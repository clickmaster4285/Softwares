...
export function ProjectCTAHero() {
  ...
  <div
    className="relative h-[420px] w-96 overflow-hidden"
  ...
  >
    <div ref={trackRef} className="flex flex-col gap-5 will-change-transform">
      {loop.map((c, i) => (
        <div
          key={i}
          className="rounded-2xl border border-primary-foreground/40 bg-primary-foreground/5 px-6 py-7 text-center backdrop-blur-sm transition hover:bg-primary-foreground/15"
        >
