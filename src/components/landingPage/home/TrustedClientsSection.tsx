               ...
               <div className="overflow-hidden">
                  ...
                  >
                     {duplicatedClients.map((client, idx) => (
                        <div
                           key={`${client.name}-${idx}`}
                           className="flex-shrink-0 px-6 py-3 bg-white rounded-full border border-gray-200 hover:border-primary-300 hover:bg-primary-50 hover:shadow-md transition-all duration-300 hover:scale-105 cursor-default"
                        >
                           <p className="text-sm font-semibold text-gray-700 hover:text-primary-600 whitespace-nowrap">
                              {client.name}
                           </p>
                        </div>
                     ))}
