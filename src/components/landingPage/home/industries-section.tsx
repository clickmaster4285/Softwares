  ...
  const handleCardHover = (index: number, isHovering: boolean) => {
    ...
    if (isHovering) {
      ...
      gsap.to(card, {
        ...
        boxShadow: "0 30px 40px -20px rgba(107,114,128,0.3), 0 10px 20px -10px rgba(0,0,0,0.1)",
        borderColor: "#f97316",
        duration: 0.4,
        ease: "power2.out"
      });
      ...
      if (!shine) {
       ...
       shine.style.background = `radial-gradient(circle at 50% 0%, hsl(var(--primary) / 0.1), hsl(var(--primary) / 0) 70%)`;
    ...
    >
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((industry, index) => {
            ...
            return (
              ...
              >
                {/* Premium Card Design */}
                <div className="relative bg-white rounded-2xl p-6 border border-primary/10 shadow-[0_4px_20px_rgb(0,0,0,0.02)] h-full overflow-hidden">
                  ...
                  <div className="card-stats pt-3 border-t border-primary/20 flex items-baseline justify-between">
                    <div>
        ...
        <div ref={ctaRef} className="mt-20">
          <div className="relative bg-gradient-to-br from-gray-50 to-primary/20 rounded-3xl p-12 overflow-hidden border border-primary/10">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <motion.div
                className="flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-12 mt-8 pt-8 border-t border-primary/10"
              >
                {stats.map((stat, idx) => (
                  <motion.div
                    key={idx}
