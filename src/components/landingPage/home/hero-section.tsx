    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 py-12 md:py-20">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ClickMasters builds custom software, web applications, mobile apps, and ERP solutions.
            We are a software development company that turns your ideas into reliable, scalable
            software.
          </motion.p>
          ...
          >
            ...
            >
              <Button
                size="lg"
                className="w-full sm:w-auto bg-primary text-white hover:bg-primary px-8 py-6 text-lg rounded-xl shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/50 transition-all relative overflow-hidden group"
                asChild
              >
            ...
            >
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto px-8 py-6 text-lg rounded-xl bg-black/30 backdrop-blur-sm border-2 border-white/20 hover:bg-black/40 text-white hover:border-primary/50 transition-all"
                asChild
              >
                <Link href="/services">
          ...
          >
            {stats.map((stat, index) => (
              <motion.div key={index} className="text-left relative" role="listitem">
                <div className="relative z-10 p-4 pl-0">
                  ...
                  <p className="text-sm text-gray-300 mt-1 text-left">{stat.label}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
