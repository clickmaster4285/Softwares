            ...
            >
              ...
              <motion.div style={{ y: translateContents[index] }}>
                <Button
                  asChild
                  size="default"
                  className="group bg-primary hover:bg-secondarytext-white rounded-full px-4 sm:px-5 py-2 sm:py-2.5 text-sm sm:text-base shadow-md w-full sm:w-auto"
                >
      ...
      <div className='w-full flex flex-col items-center justify-center px-4 py-8 sm:py-12'>
        ...
        >
          ...
          <Button 
            asChild 
            size="default" 
            className="bg-primary hover:bg-secondarytext-white rounded-full px-6 sm:px-8 mt-3 w-full sm:w-auto"
          >
            <Link href="/contact">
              Start Project
