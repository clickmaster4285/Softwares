...
const pages: HireUsPageContent[] = hireUsItems.map((title) => {
...
export function getAllHireUsSlugs(): string[] {
  return pages.map((page) => page.slug);
}

export function getHireUsPage(slug: string): HireUsPageContent | undefined {
